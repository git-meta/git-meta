# git-meta refs transfer scenarios

This document lists 12 interesting scenarios for exchanging metadata through git-meta refs, and what the current project does in each case.
...
How git-meta handles it:
- For legacy missing tombstones in fast-forward: if a key existed in previous local tree but is absent in incoming tree, git-meta removes it locally.
